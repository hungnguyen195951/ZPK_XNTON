...
@EndUserText.label: 'Ngày nhập kho lần đầu Characteristic value - Z_NGAYNHAPKHO'
...
define view entity ZI_BATCH_NGAYNHAPKHO
  as select from I_Batch
    ...
    inner join   I_ClfnCharacteristic                                            on  I_ClfnCharacteristic.CharcInternalID = I_ClfnObjectCharcValForKeyDate.CharcInternalID
                                                                                 and I_ClfnCharacteristic.Characteristic  = 'Z_NGAYNHAPKHO'
{
